  ...
  listTestimoni = [
    {
      ...
      rating: "4.5",
      testimoni:
        "Skill Intern has revolutionized my learning journey, providing top-notch programs and resources that have truly elevated my skills and knowledge",
    },
    {
      name: "Akhil",
      college: "SKIT",
      rating: "4.3",
      testimoni:
        "Skill Intern not only honed my skills but also helped me achieve something remarkable securing a patent for my major project.",
    },
    {
      name: "Pavan",
      college: "GITAM",
      rating: "4.5",
      testimoni:
        "Thanks to Skill Intern, I secured a job placement midway through my course, making my learning experience truly rewarding and practical",
    },
    {
      name: "Sakshi ",
      college: "DU",
      rating: "4.5",
      testimoni:
        "Skill Intern played a pivotal role in helping me clear my backlogs, providing the necessary resources and support to get back on track with my studies",
    },
  ],
}) => {
  const settings = {
